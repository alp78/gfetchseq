...
The output will include the interval file converted to bed format, and a friendly formatted fasta with all sequences downloaded to current folder, with record IDs in the following form:
